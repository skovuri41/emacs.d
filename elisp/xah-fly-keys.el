...
(defun xah-fly-command-mode-init ()
  ...
  (progn
    ...
    (define-key xah-fly-key-map (kbd "-") 'split-window-vertically)
    ...
    (define-key xah-fly-key-map (kbd "fr") 'ivy-recent)
    ...
    ;; (define-key xah-fly-key-map (kbd "go") 'smartscan-symbol-go-backward)
    (define-key xah-fly-key-map (kbd "j") 'backward-char)
    ...
    (define-key xah-fly-key-map (kbd "s") 'embrace-comander)
    (define-key xah-fly-key-map (kbd "t") 'xah-fly-insert-mode-activate)
    ...
    (define-key xah-fly-key-map (kbd "x") 'helm-M-x)
