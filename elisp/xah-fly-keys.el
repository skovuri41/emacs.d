...
(defun xah-fly-command-mode-init ()
  ...
  (progn
    ...
    (define-key xah-fly-key-map (kbd "bml") 'helm-bookmarks)
    (define-key xah-fly-key-map (kbd "bmm") 'bookmark-set)
    (define-key xah-fly-key-map (kbd "bmj") 'helm-bookmarks)
    (define-key xah-fly-key-map (kbd "bms") 'bookmark-save)
    (define-key xah-fly-key-map (kbd "bmt") 'bm-toggle)
